            ...
            <div className="grid-2">
                ...
                <div className="grid-field">
                    ...
                    <div className="radio-group">
                        <RadioCard label="Sí" value="SI" selected={form.certificado_docencia === "SI"} onChange={v => handleRadio("certificado_docencia", v)} />
                ...
                <div className="grid-field">
                    ...
                    <div className="radio-group">
                        <RadioCard label="Sí" value="SI" selected={form.certificado_teleformacion === "SI"} onChange={v => handleRadio("certificado_teleformacion", v)} />
                ...
                <div className="grid-field full-width">
                    ...
                    <div className="radio-group">
                        <RadioCard label="Sí" value="SI" selected={form.trabajado_con_orbel === "SI"} onChange={v => handleRadio("trabajado_con_orbel", v)} />
                        <RadioCard label="No" value="NO" selected={form.trabajado_con_orbel === "NO"} onChange={v => handleRadio("trabajado_con_orbel", v)} />
                    </div>
                    {form.trabajado_con_orbel === "SI" && (
                        <div style={{ marginTop: 8 }}>
